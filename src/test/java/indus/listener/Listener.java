...
public class Listener implements ITestListener {
	...
	public void onTestStart(ITestResult result) {
		...
		if (info != null) {
			// extent.createTest(info.businessName());
			ExtentTestManager.getTest().assignAuthor(info.author());

			//ExtentTestManager.getTest().assignCategory(info.category());
		...
		// WebDriverFactory.getDriver()).getCapabilities();
